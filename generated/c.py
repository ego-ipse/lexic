...
Root.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[IrItem(IrRuleRef("root-item"), IrQuantifier(0, None))],
...
Declaration.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(IrLiteral(")"), IrQuantifier(1, 1)),
        IrItem(IrLiteral("{"), IrQuantifier(1, 1)),
        IrItem(IrRuleRef("statement"), IrQuantifier(0, None)),
        IrItem(IrLiteral("}"), IrQuantifier(1, 1)),
    ],
...
Identifier.__grammar__ = RuleSpec(
    ...
    kind="value_str",
    items=[
        IrItem(IrCharClass("a-zA-Z_"), IrQuantifier(1, 1)),
        IrItem(IrCharClass("a-zA-Z_0-9"), IrQuantifier(0, None)),
    ],
    field_map={},
    non_semantic_fields=frozenset([]),
)
                ...
                IrAlternation(
                    arms=(
                        IrSequence(
                            items=(
                                IrItem(
                                    IrRuleRef("singleLineComment"), IrQuantifier(1, 1)
                                ),
                            )
                        ),
                    )
                ...
                IrAlternation(
                    arms=(
                        IrSequence(
                            items=(
                                IrItem(
                                    IrRuleRef("multiLineComment"), IrQuantifier(1, 1)
                                ),
                            )
                        ),
                    )
            ...
            IrGroup(
                IrAlternation(
                    arms=(
                        ...
                        IrSequence(items=(IrItem(IrLiteral("<"), IrQuantifier(1, 1)),)),
                        IrSequence(
                            items=(IrItem(IrLiteral("=="), IrQuantifier(1, 1)),)
                        ),
                        IrSequence(
...
Expression.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(IrRuleRef("expression-item"), IrQuantifier(0, None)),
    ],
...
Term.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(IrRuleRef("term-item"), IrQuantifier(0, None)),
    ],
...
ArgList.__grammar__ = RuleSpec(
    ...
    items=[
        IrItem(IrRuleRef("expression"), IrQuantifier(1, 1)),
        IrItem(IrRuleRef("argList-item"), IrQuantifier(0, None)),
    ],
        ...
        IrItem(
            IrGroup(
                IrAlternation(
                    arms=(
                        IrSequence(
                            items=(IrItem(IrNot(IrCharClass("*")), IrQuantifier(1, 1)),)
                        ),
                        IrSequence(
                            items=(
                                IrItem(
