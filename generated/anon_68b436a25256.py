"""Generated module: anon_68b436a25256. Do not edit; regenerated from grammar."""
...
Hiragana.__grammar__ = RuleSpec(
    ...
    kind="value_str",
    items=[IrItem(IrCharClass("ぁ-ゟ", negated=False), Quantifier(1, 1))],
    field_map={},
    non_semantic_fields=frozenset([]),
)
...
Katakana.__grammar__ = RuleSpec(
    ...
    parent_class_name="JpChar",
    kind="value_str",
    items=[IrItem(IrCharClass("ァ-ヿ", negated=False), Quantifier(1, 1))],
    field_map={},
    non_semantic_fields=frozenset([]),
)
...
Cjk.__grammar__ = RuleSpec(
    ...
    parent_class_name="JpChar",
    kind="value_str",
    items=[IrItem(IrCharClass("一-鿿", negated=False), Quantifier(1, 1))],
    field_map={},
    non_semantic_fields=frozenset([]),
)
