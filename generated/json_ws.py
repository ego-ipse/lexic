"""Auto-generated Pydantic models from /home/mika/projects/vyx_2/resources/ground_truth/json_ws.gbnf."""
...
class Number(Value):
    ...
    __grammar__: ClassVar[RuleSpec] = RuleSpec(
        ...
        items=[
            ...
            CharClassAtom("([0-9]|[1-9][0-9])", min=1, max=1),
            CharClassAtom('("."[0-9])', min=0, max=1),
            CharClassAtom("([eE][-+][0-9][1-9])", min=0, max=1),
            RuleRefAtom("ws", min=1, max=1),
        ],
