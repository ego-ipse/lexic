...
Value.__grammar__ = RuleSpec(
    ...
    kind="alternation",
    items=[
        IrItem(IrRuleRef("false")),
        IrItem(IrRuleRef("null")),
        IrItem(IrRuleRef("true")),
...
Int.__grammar__ = RuleSpec(
    ...
    parent_class_name="GrammarModel",
    kind="alternation",
    items=[IrItem(IrRuleRef("zero")), IrItem(IrRuleRef("int-arm2"))],
    field_map={},
    non_semantic_fields=frozenset([]),
)
...
Char.__grammar__ = RuleSpec(
    ...
    parent_class_name="GrammarModel",
    kind="alternation",
    items=[IrItem(IrRuleRef("unescaped")), IrItem(IrRuleRef("char-arm2"))],
    field_map={},
    non_semantic_fields=frozenset([]),
)
...
ObjectItem.__grammar__ = RuleSpec(
    ...
    parent_class_name="GrammarModel",
    kind="sequence",
    items=[IrItem(IrRuleRef("value-separator")), IrItem(IrRuleRef("member"))],
...
ArrayItem.__grammar__ = RuleSpec(
    ...
    parent_class_name="GrammarModel",
    kind="sequence",
    items=[IrItem(IrRuleRef("value-separator")), IrItem(IrRuleRef("value"))],
