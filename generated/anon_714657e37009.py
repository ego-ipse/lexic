...
Root.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[IrItem(atom=IrRuleRef("expr"), quantifier=IrQuantifier(1, 1))],
    field_map={"expr": 0},
...
Expr.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(atom=IrRuleRef("op"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrRuleRef("term"), quantifier=IrQuantifier(1, 1)),
    ],
...
Term.__grammar__ = RuleSpec(
    ...
    parent_class_name="GrammarModel",
    kind="sequence",
    items=[IrItem(atom=IrRuleRef("num"), quantifier=IrQuantifier(1, 1))],
    field_map={"num": 0},
    non_semantic_fields=frozenset([]),
)
