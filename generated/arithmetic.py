...
Root.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[IrItem(atom=IrRuleRef("root-item"), quantifier=IrQuantifier(1, None))],
...
Expr.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(atom=IrRuleRef("expr-item"), quantifier=IrQuantifier(0, None)),
    ],
...
Term.__grammar__ = RuleSpec(
    ...
    kind="alternation",
    items=[
        IrItem(atom=IrRuleRef("ident"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrRuleRef("num"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrRuleRef("term-arm3"), quantifier=IrQuantifier(1, 1)),
    ],
    field_map={},
    non_semantic_fields=frozenset([]),
)
...
TermArm3.__grammar__ = RuleSpec(
    ...
    items=[
        ...
        IrItem(atom=IrRuleRef("expr"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrLiteral(")"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrRuleRef("ws"), quantifier=IrQuantifier(0, 1)),
    ],
...
Ident.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[
        IrItem(atom=IrCharClass("a-z"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrCharClass("a-z0-9_"), quantifier=IrQuantifier(0, None)),
        IrItem(atom=IrRuleRef("ws"), quantifier=IrQuantifier(0, 1)),
    ],
...
Num.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[
        IrItem(atom=IrCharClass("0-9"), quantifier=IrQuantifier(1, None)),
        IrItem(atom=IrRuleRef("ws"), quantifier=IrQuantifier(0, 1)),
    ],
...
ExprItem.__grammar__ = RuleSpec(
    ...
    kind="sequence",
    items=[
        IrItem(atom=IrCharClass("-+*/"), quantifier=IrQuantifier(1, 1)),
        IrItem(atom=IrRuleRef("term"), quantifier=IrQuantifier(1, 1)),
    ],
