"""Tests for lexic.parsing.earley.kernel.forest.support.trampoline — depth-safe trampoline driver.
...
from lexic.parsing.earley.kernel.forest.forest import IrStream
