"""Tests for lexic.parsing.pda.specs — the clone-compiler intermediate records.

Pins the field order and defaults of the NamedTuple vocabulary the clone
compiler builds and :mod:`lexic.parsing.pda.clones` re-exposes as its public
...
from lexic.parsing.pda import clones
