"""Tests for lexic.parsing.pda.errors — PdaFail.

Homed in its own leaf module so :mod:`~lexic.parsing.pda.runtime` and
:mod:`~lexic.parsing.pda.islands` can both raise it without an import cycle;
...
from lexic.parsing.pda.runtime import PdaFail as RuntimePdaFail
