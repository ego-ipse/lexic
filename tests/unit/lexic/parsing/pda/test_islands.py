"""Tests for lexic.parsing.pda.islands — the island sub-parse + splice.

Shed from :class:`~lexic.parsing.pda.runtime.PdaKernel` as free functions
...
from lexic.parsing.pda.islands import island_derivation, island_parse, island_run
