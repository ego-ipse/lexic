...
Covers the behavioural contract of :mod:`~lexic.ir.action.mapping` (key lookup,
...
The two concrete maps are siblings under :class:`~lexic.ir.action.mapping.IrMapping`;
:class:`~lexic.ir.action.mapping.IrMultiMap` reads return the **live** bucket (no
snapshot copy).
"""
