/* The railroad — one rule's body as track. Carved out of leaf.js: it is
   one surface with its own geometry, its own registers and its own hit
   testing, and it shares nothing with the chart or the planes. */
