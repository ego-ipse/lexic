...
Its own module because both the frame and the surfaces it draws need the
vocabulary, and a surface importing the frame that imports it back is a
circle waiting to happen.
"""
