...
FONTS = {
    ...
    "winhead": f"11px {SANS}",
    # Compact pin copy is 12px mono; its facts and address are 11px mono.
    # The ordinary frame body is 12.5px and the generic chip is 10px, so
    # borrowing either is visibly the wrong popup.
    "pinbody": f"12px {CODE}",
    "pinfact": f"11px {CODE}",
    "pinaddr": f"11px {CODE}",
