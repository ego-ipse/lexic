...
(:mod:`lexic.parsing_2.kernel`), packed as ints. What remains here is the
...
shared, packed parse forest (SPPF): :mod:`~lexic.parsing_2.forest` walks it
as a DAG.

A :class:`Chart` is produced by :meth:`~lexic.parsing_2.kernel.Kernel
