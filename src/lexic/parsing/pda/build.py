...
The slot layout of the :class:`~lexic.parsing.pda.runtime.PdaKernel` descent
...
and its reduce twin both call. Imports only :mod:`lexic.parsing.pda.flatten`
(the flat records + field-mode codes), :mod:`lexic.parsing.fold`
(:class:`RuleFold`) and :mod:`lexic.parsing.pda.errors`
...
from lexic.parsing.pda.flatten import M_GTEXT, M_MODEL, M_MODELS, FlatClone
...
# class *cursor* is :class:`~lexic.parsing.pda.runtime.PdaKernel` itself),
...
def finish_delegate(
    ...
    The shared body of both :meth:`~lexic.parsing.pda.runtime.PdaKernel
...
def build_fast(
    ...
    :func:`build_sequence` and :meth:`~lexic.parsing.pda.runtime.PdaKernel
    ._run_leaf`.
