...
(:mod:`lexic.parsing.earley.kernel.loop.kernel`), packed as ints. What remains here is the
...
shared, packed parse forest (SPPF): :mod:`~lexic.parsing.earley.kernel.forest.forest` walks it
as a DAG.

A :class:`Chart` is produced by :meth:`~lexic.parsing.earley.kernel.loop.kernel.Kernel
...
:class:`~lexic.parsing.earley.kernel.forest.forest.SppfNode` referencing a completed sub-derivation
